const Map<String, String> enAccount = {
  ...
  'warn.external':
      'You do not own this OBSERVATION ACCOUNT in Web3 Wallet, so never transfer tokens into this address unless you are sure you own this account in other wallets.',
};
...
const Map<String, String> zhAccount = {
  ...
  'warn.external': '在 Web3 Wallet 中你未拥有该【观察账户】的签名权，请勿转入资产，除非你在其他管理器中有该账户签名权。',
};
